 ...
 *
 * @author whaless.net @gmail.com
 */
@ApiModel(value = "异常码", description = "异常码信息")
@Getter
...
// 1002 数据中心
     ...
     */
    MDC10021015(10021015, "商品不是上架售卖状态"),
    /**
     ...
     */
    MDC10021017(10021017, "商品未启用，不能进行购买"),
    /**
     ...
     * Mdc 10021024 error code enum.
     */
    MDC10021025(10021025, "启用状态商品不能修改"),

    MDC10021026(10021026, "上架状态商品不能修改"),

    MDC10021027(10021027, "上架状态商品不能删除"),

    MDC10021028(10021028, "商品已启用不能删除"),

    /**
     * Mdc 10021029 error code enum.
     */
    MDC10021029(10021029, "获取商品信息失败"),
...
// 1003 订单中心
     ...
     */
    OMC10031010(10031010, "非小鲸学习的订单, 回调忽略"),
    /**
    ...
    OMC10031017(10031017, "此订单不能取消, orderStatus=%s"),

    OMC10031018(10031018, "生成订单时金额与应付款金额不一致"),

    OMC10031019(10031019, "订单编号不能为空"),

    OMC10031020(10031020, "课时包已过期，不能使用"),

    OMC10031021(10031021, "订单需要支付金额大于0，请支付金额完成订单：待支付金额=%s"),
...
// 1005 任务中心
    ...
    EXISTS(10050016, "该数据已在"),

    NOEXISTS(10050017, "无数据"),

    GATEWAY_ERROR(10050016, "网关异常"),

    GATEWAY_CONNECT_TIME_OUT(10050018, "网关超时"),

    TOKEN_IS_EXP(10050019, "token失效或过期"),

    GATEWAY_NOT_FOUND_SERVICE(10050020, "服务未找到"),

    INSUFFICIENT_SCOPE(10050402, "授权不足"),

    TOKEN_NOT_EXIST(10050401, "Authorization不存在"),

    TOKEN_IS_UPDATE(10050403, "token信息已经更新"),

    SYSTEM_ERROR(9999999, "系统异常"),

    FIND_USER_ERROR(10050021, "用户信息获取失败"),

    VC_CODE_ERROR(10050022, "请输入正确的验证码"),

    CUSTOMER_REPEAT(10050023, "你已添加过该客户，请勿重复添加。"),

    CUSTOMER_REPEAT_AUTH(10050024, "机构已存在该客户，已进行客户验证，是否继续添加。"),

    CUSTOMER_REPEAT_NO_AUTH(10050025, "机构已存在该客户，未进行客户验证，是否继续添加。"),

    BUSINESS_ACCOUNT_DISABLE(10050026, "当前商户已冻结，无法登陆。"),

    VERIFY_BIND_PHONE(10050027, "账号已存在。"),

    JE10050028(10050028, "输入金额有误，最大金额不得超过6位。"),

    REAL_CUSTOMER_REPEAT(10050029, "当前客户已在学校存在，继续添加存在不可验证的风险，请勿重复添加；是否继续，点击是，继续添加为虚拟客户；点击否，取消本次添加"),
